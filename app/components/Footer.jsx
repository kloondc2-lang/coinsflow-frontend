...
export default function Footer() {
  return (
    <footer className="mt-auto transition-colors duration-300">
      ...
      {/* Disclaimer */}
      <div className="py-4 px-6 text-center text-[11px] text-gray-400 dark:text-gray-500 font-extrabold leading-relaxed">
      ...
      {/* Main footer row */}
      <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 sm:grid-cols-3 items-center gap-6 text-[12px] text-gray-400 dark:text-gray-500">
        ...
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-2">
          {footerLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="font-extrabold text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white hover:font-black transition-colors"
            >
              {link.label}
            </Link>
          ))}
